    ...
    <section class="text-gray-600 body-font" id="joinUsSection">
        <div class="container mx-auto flex md:flex-row flex-col items-center">
            <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
                ...
                <div
                    class="max-w-4xl mt-5 mb-3 p-6 mx-auto bg-indigo-600 rounded-md shadow-md dark:bg-white-800 mt-0 mb-10 max-w-sm bg-white border border-white-200 rounded-lg shadow dark:bg-white-800 dark:border-white-700">
                    <a href="#">
                        <h5 id="flash_subject_prev"
                            class="mb-3 text-2xl font-bold tracking-tight text-gray-900 dark:text-black">
                            ...
                            <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <input name="flash_title" value="<?php echo $flash_notice['title']; ?>"
                                        ...
                                        class="block w-full px-4 py-2 mt-2 text-black-700 bg-white border border-white-300 rounded-md dark:bg-white-800 dark:text-black-300 dark:border-white-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                                </div>

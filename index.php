...
<section class="container mx-auto px-4 py-6 grid grid-cols-1 md:grid-cols-2 gap-8">
  <div class="bg-white p-6 rounded-lg shadow-md transition hover:scale-105 hover:shadow-lg hover:bg-gray-100">
    ...
    <p class="text-base sm:text-lg text-gray-700 leading-relaxed"><?= isset($row['eight']) ? $row['eight'] : '' ?></p>
  </div>
  <div class="bg-white p-6 rounded-lg shadow-md transition hover:scale-105 hover:shadow-lg hover:bg-gray-100">
    <h1 class="text-2xl sm:text-3xl font-bold text-gray-800 border-b-2 border-[#8A6640] pb-2">
...
<div id="info-popup" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-60">
  <div class="bg-white rounded-xl shadow-2xl w-full max-w-sm mx-4 p-6 relative max-h-[90vh] overflow-y-auto">
    ...
    <div class="flex flex-col sm:flex-row justify-center gap-4">
      <a href="aboutus.php" class="inline-flex justify-center items-center text-sm font-semibold text-[#a9745a] hover:underline transition">

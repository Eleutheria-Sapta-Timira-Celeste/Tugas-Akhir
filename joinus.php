    ...
    <main>
        <section class="max-w-4xl p-6 mx-auto bg-indigo-600 rounded-md shadow-md dark:bg-gray-800 mt-0 mb-10">
            ...
            <h1 class="hide_after_submission text-x text-white capitalize dark:text-white">Pastikan untuk mengisi formulir pendaftaran Anda dengan hati-hati.
                 ...
                 Jika Anda memiliki pertanyaan, jangan ragu untuk menghubungi bagian pendaftaran untuk mendapatkan bantuan.</h1>
            ...
            <div style="display: none;" id="alert-additional-content-3"
                ...
                <div class="flex items-center">
                    ...
                    <h3 class="text-lg font-medium">Terima Kasih Sudah Mendaftar</h3>
                </div>
                <div class="mt-2 mb-4 text-sm">

                Administrator SMP PGRI 371 Pondok Aren akan segera menghubungi Anda untuk proses pendaftaran.
                Kami mengundang Anda untuk berkunjung ke sekolah kami pada waktu yang paling nyaman.
                ...
                <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                    ...
                    <div>
                        <label class="text-white dark:text-gray-200">NISN <span
                                style="color: red;">*</span></label>
                        <input placeholder="Nomor Induk SIswa Nasional" required name="nisn" type="text"
                            class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                    </div>

                    <div>
                        <label class="text-white dark:text-gray-200">NIK <span
                                style="color: red;">*</span></label>
                        <input placeholder="Nomor Induk Kependudukan" required name="nik" type="text"
                            class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                    </div>
                    <div>
                        <label class="text-white dark:text-gray-200">Alamat <span style="color: red;">*</span></label>
                        <input placeholder="Silahkan isi dengan alamat lengkap" id="address" required name="address" type="text"
                            class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                    </div>

                    <div>
                        <label class="text-white dark:text-gray-200">Jenis Kelamin <span style="color: red;">*</span></label>
                        <select name="gender"
                            class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                    ...
                    <div>
                        <label class="text-white dark:text-gray-200">Tempat Lahir <span
                                style="color: red;">*</span></label>
                        <input placeholder="Isi dengan tempat lahir anak" required name="tempat_lahir" type="text"
                            class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                    </div>
                    <div>
                        <label class="text-white dark:text-gray-200">Tanggal Lahir<span
                                style="color: red;">*</span></label>
                        <input required name="dob" id="date" type="date"
                            class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                    </div>
                    <div>
                        <label class="text-white dark:text-gray-200">Agama <span
                                style="color: red;">*</span></label>
                        <select name="Kepercayaan yang dianut"
                            class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                    ...
                    <div>
                        <label class="text-white dark:text-gray-200">Nama Ayah <span
                                style="color: red;">*</span></label>
                        <input placeholder="Nama sesuai kartu identitas" name="father_name" required type="text"
                            class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                    </div>

                    <div>
                        <label class="text-white dark:text-gray-200">Nama Ibu <span
                                style="color: red;">*</span></label>
                        <input placeholder="Nama sesuai kartu identitas" name="mother_name" required type="text"
                            class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                    </div>
                    <div>
                        <label class="text-white dark:text-gray-200">Asal Sekolah</label>
                        <input placeholder="Asal Sekolah SD" name="previous_school" type="text"
                            class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                    </div>
                    <div>
                        <label class="text-white dark:text-gray-200">Email</label>
                        <input placeholder="emailkamu@gmail.com" id="email" name="email" type="text"
                            class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                    </div>

                    <div>
                        <label class="text-white dark:text-gray-200">Nomor Telepon<span
                                style="color: red;">*</span></label>
                        <input placeholder="12345678" id="phone" required name="phone" type="text"
                            class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                    </div>

                    <div>
                        <label class="text-white dark:text-gray-200">Tuliskan Perkenalan Singkat Tentang Kamu <span
                                style="color: red;">*</span></label>
                    ...
                    <div class="flex justify-start ml-5 mt-6">
                        ...
                        <label for="default-checkbox" class="text-white ml-5 dark:text-gray-200">Konfirmasi, saya sudah memeriksanya kembali.</label>
                    </div>
                    <div class="flex justify-end mt-6">

                        <button name="register_student"
                            class="px-6 py-2 leading-5 text-white transition-colors duration-200 transform bg-pink-500 rounded-md hover:bg-pink-700 focus:outline-none focus:bg-gray-600">Daftar</button>
                    </div>
            </form>
        </section>

...
<script>
    // Ensure the alert appears smoothly when the page loads
    window.onload = function() {
        let alertBox = document.getElementById("alert-border-3");
        alertBox.style.display = "flex"; 
        setTimeout(() => {
            alertBox.style.opacity = "1";
        }, 200); // Short delay for smooth entrance
    };

    function closethankfeedback() {
        let alertBox = document.getElementById("alert-border-3");
        alertBox.style.opacity = "0"; // Fade-out animation
        setTimeout(() => {
            alertBox.style.display = "none"; // Remove element after fade

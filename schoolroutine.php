...
<section class="text-gray-600 body-font">
    <div class="container px-5 py-10 mx-auto">
        <div class="flex flex-col text-center w-full mb-20">
            <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-[#a9745a]">Jadwal Kelas</h1>
        ...
        <div class="lg:w-1/4 md:w-1/2 p-4 w-full">
            ...
            <div class="mt-4">
                <form method="post" id="album' . $class. '">
                    ...
                    if ($row["routine_url"] != "") {
                        echo '<button onclick="window.open(\'' . $routine . '\', \'_blank\', \'fullscreen=yes\');" class="mt-1 focus:outline-none text-white bg-[#5c3d15] hover:bg-[#4b320f] focus:ring-4 focus:ring-[#4b320f] font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-[#5c3d15] dark:hover:bg-[#5c3d15] dark:focus:ring-[#4b320f]">Lihat Jadwal</button>';
                    }
                    echo '
                </form>
            </div>

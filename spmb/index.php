...
<body class="bg-gray-100 font-sans flex flex-col min-h-screen">
  ...
  <main class="flex-1 pt-[10px] pb-[60px]"> <!-- Padding agar tidak ketutupan header/footer -->
    <section class="bg-white p-6 shadow rounded mx-4">
      <div class="flex justify-between items-center">
        <div>
          <h2 class="text-xl font-semibold text-[#a9745a]">SMP PGRI 371 Pondok Aren</h2>
  ...
  <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
    ...
    <!-- 01 -->
    <div class="bg-white p-4 rounded shadow border-l-4 border-[#4b320f]">
      ...
      <a href="persyaratan.php" class="text-[#a9745a] text-sm mt-2 inline-block hover:underline">Lihat Persyaratan</a>
    </div>
    ...
    <div class="bg-white p-4 rounded shadow border-l-4 border-[#4b320f]">
      ...
      <a href="daftar.php" class="text-[#a9745a] text-sm mt-2 inline-block hover:underline">Daftar Online</a>
    </div>
    ...
    <div class="bg-white p-4 rounded shadow border-l-4 border-[#4b320f]">
      ...
      <span class="text-[#a9745a] text-sm mt-2 inline-block italic">Cetak Formulir akan tersedia setelah pendaftaran selesai</span>
    ...
    <div class="bg-white p-4 rounded shadow border-l-4 border-[#4b320f]">
      ...
      <a href="verifikasi.php" class="text-[#a9745a] text-sm mt-2 inline-block hover:underline">Panduan Verifikasi</a>
    </div>
    ...
    <div class="bg-white p-4 rounded shadow border-l-4 border-[#4b320f]">
      ...
      <a href="informasi.php" class="text-[#a9745a] text-sm mt-2 inline-block hover:underline">Cek Informasi Terbaru</a>
    </div>

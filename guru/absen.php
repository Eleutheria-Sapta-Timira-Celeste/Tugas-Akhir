    ...
    <main>
        <section class="text-gray-600 body-font">
            ...
            <div class="flex flex-col text-center w-full mb-20">
                <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-[#ef6c00]"> Selamat Datang di Panel Guru</h1>
                <p class="text-sm md:text-base lg:w-2/3 mx-auto leading-relaxed text-base">
                Selamat Datang di Panel Guru SMP PGRI 371 Pondok Aren 🏫
...
<script>
function add_notice() {
    window.location.href = "jadwalmengajar.php";
}

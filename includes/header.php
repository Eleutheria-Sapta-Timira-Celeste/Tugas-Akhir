...
<header id="navbar"
    ...
    <div class="container mx-auto flex flex-wrap items-center justify-between p-4 md:p-5">
        <!-- Logo -->
        <a onclick="homepage()" class="flex items-center cursor-pointer">
            <img src="assects/images/defaults/logoweb.png" alt="Logo" class="h-14 md:h-16 w-auto">
        </a>

        <!-- Menu + SPMB Group -->
        <div class="flex items-center space-x-4 md:space-x-6">
            <nav class="flex space-x-3 md:space-x-5 font-semibold text-sm md:text-base items-center">
            ...
            <button onclick="window.location.href='spmb/index.php'"
                class="text-white bg-[#a66c30] hover:bg-[#a66c30] font-medium rounded-md text-sm px-5 py-2 text-center transition flex items-center">
                SPMB

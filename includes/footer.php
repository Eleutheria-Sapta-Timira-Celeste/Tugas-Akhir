<footer class="bg-gradient-to-br from-amber-200 to-orange-300 text-gray-900 py-12 shadow-inner">
    <div class="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 px-6">
        ...
        <div class="space-y-4 transition duration-300 hover:scale-105 hover:shadow-md">
            ...
            <ul class="mt-2 space-y-2 text-base">
                ...
                <li><a href="#" class="hover:text-orange-700 transition">Instagram</a></li>
            </ul>
        </div>
    ...
    <div class="mt-10 text-center border-t border-orange-600 pt-6">
        ...
        <div class="flex justify-center space-x-5 mt-3">
            ...
            <a href="#" class="hover:text-orange-700 transition text-lg"><i class="fab fa-twitter"></i></a>
            <a href="#" class="hover:text-orange-700 transition text-lg"><i class="fab fa-instagram"></i></a>
            <a href="#" class="hover:text-orange-700 transition text-lg"><i class="fab fa-linkedin"></i></a>
        </div>
    </div>
</footer>